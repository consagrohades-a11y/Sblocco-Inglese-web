...
export default function StickyMobileCTA() {
  ...
  const isAssessment = location.pathname === '/assessment' || location.pathname.startsWith('/profilo/');
  ...
  if (!isLearner && isAssessment) return null;
    ...
    <div className="fixed inset-x-0 bottom-0 z-40 border-t border-white/10 bg-[#0b1311]/95 px-4 py-3 text-white shadow-[0_-14px_38px_rgba(3,8,7,0.28)] backdrop-blur-xl xl:hidden">
      <div className="mx-auto flex max-w-md items-center gap-3">
        ...
        {isLearner && assignmentReturnTo ? (
          ...
          <Link to="/assessment" className="focus-ring inline-flex min-h-11 shrink-0 items-center gap-2 rounded-full bg-[#13866f] px-4 py-2.5 text-sm font-black text-white shadow-[0_8px_24px_rgba(14,124,102,0.24)] transition hover:bg-[#18a085]">
            Inizia
