...
const guideChapters = [
  ...
  },
  {
    ...
    icon: BookMarked,
    title: 'Vocabolario',
    copy: 'Le parole e i chunk incontrati nelle attività restano raccolti nel tuo Vocabolario, così puoi ritrovarli senza cercare tra esercizi e messaggi.',
    note: 'Il Vocabolario accompagna il percorso e conserva il linguaggio utile che hai già incontrato.',
    to: '/vocab-bank',
