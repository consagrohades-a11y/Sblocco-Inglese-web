...
export default function AdminExerciseCollections() {
  ...
  return <><SEO title="Collections | Exercise Builder" description="Crea e pubblica percorsi versionati di domande, pool ed esercizi." /><section className="section-shell py-8 lg:py-10"><div className="mx-auto max-w-[1500px]">
    <header className="rounded-2xl border border-ink/10 bg-white p-6 shadow-soft dark:border-white/10 dark:bg-surface-900 sm:p-8"><span className="eyebrow">Exercise Builder</span><div className="mt-4 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between"><div><h1 className="text-3xl font-black text-ink dark:text-white sm:text-4xl">Collections</h1><p className="mt-3 max-w-3xl text-sm leading-6 text-ink/65 dark:text-white/65">Componi percorsi ordinati e pubblicali come versioni immutabili. Le assegnazioni salvano uno snapshot stabile della versione selezionata.</p></div><div className="flex flex-wrap gap-2"><Link to="/admin/content/exercises/questions" className="rounded-full border border-ink/15 bg-white px-4 py-2.5 text-sm font-black text-ink dark:border-white/20 dark:bg-white/10 dark:text-white">Question Bank</Link><Link to="/admin/content/exercises/pools" className="rounded-full border border-ink/15 bg-white px-4 py-2.5 text-sm font-black text-ink dark:border-white/20 dark:bg-white/10 dark:text-white">Pool Builder</Link><button type="button" onClick={createNew} className="rounded-full bg-ink px-4 py-2.5 text-sm font-black text-white dark:bg-emerald-300 dark:text-surface-950">Nuova Collection</button></div></div></header>
