...
const fieldClass = 'mt-2 w-full rounded-xl border border-ink/15 bg-white px-4 py-3 text-sm font-semibold text-ink outline-none focus:border-moss dark:border-white/20 dark:bg-surface-800 dark:text-white';
...
export default function AdminGroups() {
  ...
  return <><SEO title="Gruppi studenti | Admin | Sblocco Inglese" description="Cohort, classi e segmenti di studenti." /><section className="section-shell py-8 lg:py-10"><div className="mx-auto max-w-7xl">
    <header className="rounded-2xl border border-ink/10 bg-white p-6 shadow-soft dark:border-white/10 dark:bg-surface-900 sm:p-8"><span className="eyebrow">Studenti</span><div className="mt-4 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between"><div><h1 className="text-3xl font-black text-ink dark:text-white sm:text-4xl">Gruppi e cohort</h1><p className="mt-3 max-w-3xl text-sm leading-6 text-ink/65 dark:text-white/65">Organizza gli studenti senza condividere assegnazioni, tentativi o feedback tra membri.</p></div><Link to="/admin/learners" className="rounded-full border border-ink/15 px-5 py-2.5 text-sm font-black dark:border-white/20">Elenco studenti</Link></div></header>
