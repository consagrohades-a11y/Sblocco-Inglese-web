        ...
        <div className="mx-auto max-w-7xl">
          ...
          <section className="mt-6 rounded-2xl border border-ink/10 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-[#16211e] sm:p-7">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
              <div><p className="text-xs font-black uppercase tracking-wide text-moss dark:text-emerald-300">Batch di importazione</p><h2 className="mt-1 text-2xl font-black text-ink dark:text-white">{batches.length} batch</h2></div>
