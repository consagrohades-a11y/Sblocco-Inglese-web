...
export default function GrammarA1Hub() {
  return (
    <>
      <SEO title="A1 English Foundations | Sblocco Inglese" description="Un percorso A1 guidato per creare frasi semplici, fare pratica e ricevere feedback specifico." />
      <section className="section-shell py-12">
        <span className="eyebrow"><BookOpen aria-hidden="true" className="h-4 w-4" />A1 English Foundations</span>
        <div className="mt-5 max-w-4xl">
          <h1 className="text-4xl font-black leading-tight sm:text-5xl dark:text-white">A1 English Foundations: dalle regole alle situazioni reali.</h1>
          <p className="mt-4 text-lg leading-8 text-ink/70 dark:text-white/70">
            A1 English Foundations ti aiuta a creare frasi semplici, fare e rispondere a domande di base, parlare della vita quotidiana e gestire situazioni semplici e prevedibili.
          </p>
        </div>
          ...
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              ...
              <p className="mt-2 max-w-3xl text-sm leading-6 text-ink/65 dark:text-white/65">
                Segui le unità in ordine: capisci la regola, la usi nella pratica, completi un checkpoint e ricevi un feedback specifico prima di riprovare.
              </p>
            </div>
          </div>
            ...
            {grammarA1Checkpoints.map((checkpoint) => (
              ...
              >
                ...
                <span className="mt-6 inline-flex items-center gap-2 rounded-full bg-ink px-4 py-2 text-sm font-black text-white transition group-hover:gap-3 dark:bg-mint dark:text-ink">
                  Apri Quick Check <ArrowRight className="h-4 w-4" />
                </span>
              </Link>
            ))}
          </div>
