...
export default function WordTrainer() {
  ...
  return (
    <>
      <SEO
        title="Word Trainer | Sblocco Inglese"
        description="Coming soon: useful English words with pronunciation, Italian meaning, examples, collocations and review timing."
      />
      <TrainerLayout>
        <div className="mx-auto max-w-3xl rounded-lg border border-ink/10 bg-white p-6 text-center shadow-soft sm:p-8">
          ...
          <p className="mt-4 text-base font-semibold leading-7 text-ink/70">
            This trainer will help you learn useful English words with pronunciation, Italian meaning, examples,
            collocations and review timing.
          </p>
