...
export const listeningComprehensionAuthoringGuide = {
  ...
  workflow: [
    ...
    'Create and attach one downloadable .json file containing the complete import-ready object after checking audio, item answers and metadata against the validation checklist. Do not paste the JSON payload into chat.',
  ],
  generation_contract: {
