...
const suitabilityResults = {
  fit: {
    ...
    title: 'Richiesta inviata: puoi procedere con slot e pagamento.',
    text:
  ...
  possible: {
    ...
    title: 'Richiesta inviata: puoi procedere, con un obiettivo molto pratico.',
    text:
  ...
  notFit: {
    ...
    title: 'Richiesta inviata, ma per ora non ti consiglio il pagamento.',
    text:
